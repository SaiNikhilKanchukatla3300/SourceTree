...
Intent i;
    public void home_lp(android.view.View v){
        ...
        switch(v.getId()){
            case R.id.ad_i:
                i = new Intent(getApplicationContext(), AndroidDevelopment.class);
                break;
            case R.id.wd_i:
                i = new Intent(getApplicationContext(), WebDevelopment.class);
                break;
            case R.id.dc_i:
                i = new Intent(getApplicationContext(), DataScience.class);
                break;
