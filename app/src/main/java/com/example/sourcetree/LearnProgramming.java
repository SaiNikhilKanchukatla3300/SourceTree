...
public class LearnProgramming extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
Intent i;
public void home_lp(android.view.View v){
            ...
            switch(v.getId()){
                case R.id.c_i:
                    ...
                    break;
                case R.id.cpp_i:
                    i = new Intent(getApplicationContext(), cplusplus.class);
                    break;
                case R.id.java_i:
                    i = new Intent(getApplicationContext(), Java.class);
                    break;
                case R.id.py_i:
                    i = new Intent(getApplicationContext(), Python.class);
                    break;
                case R.id.algo_i:
                    i = new Intent(getApplicationContext(), Algorithms.class);
                    break;
                case R.id.ds_i:
                    i = new Intent(getApplicationContext(), DataStructures.class);
                    break;
                case R.id.dc_i:
                    i = new Intent(getApplicationContext(), DifferentCompliers.class);
                    break;
            }
            startActivity(i);
